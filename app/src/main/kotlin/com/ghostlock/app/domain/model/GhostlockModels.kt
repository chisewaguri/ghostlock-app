...
data class KernelSnapshot(
    ...
    /** 0 = auto, 1+ = forced route whose name is routeChoices[index - 1]. */
    val routeChoiceIndex: Int,
    /** feasible routes in native priority order. */
    val routeChoices: List<String>,
    /** false when the kernel has one route and the picker would decide nothing. */
    val routeSelectable: Boolean,
